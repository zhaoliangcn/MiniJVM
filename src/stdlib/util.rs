...
pub struct AtomicReferenceArray;
...
impl AtomicReferenceArray {
    pub fn init() -> Method {
        ...
        Method::new_native("java.util.concurrent.atomic.AtomicReferenceArray".to_string(), "<init>".to_string(), "(I)V".to_string(), false, Some(native_impl))
    }
    ...
    pub fn get() -> Method {
        ...
        Method::new_native("java.util.concurrent.atomic.AtomicReferenceArray".to_string(), "get".to_string(), "(I)Ljava/lang/Object;".to_string(), false, Some(native_impl))
    }
    ...
    pub fn set() -> Method {
            ...
            if let Value::ObjectRef(this_id) = this_ref {
                if let Some(obj) = jvm.heap.get(*this_id) {
                    if let Some(Value::ArrayRef(arr_id)) = obj.fields.get("array") {
                        if let Some(arr) = jvm.heap.get_mut(*arr_id) {
                            if let Some(elements) = &mut arr.array_elements {
                                if i < elements.len() { elements[i] = new_val; }
                            }
                        }
                    }
                }
        ...
        Method::new_native("java.util.concurrent.atomic.AtomicReferenceArray".to_string(), "set".to_string(), "(ILjava/lang/Object;)V".to_string(), false, Some(native_impl))
    }

    pub fn register(jvm: &mut JVM) {
        jvm.method_area.add_native_method("java.util.concurrent.atomic.AtomicReferenceArray", AtomicReferenceArray::init());
        jvm.method_area.add_native_method("java.util.concurrent.atomic.AtomicReferenceArray", AtomicReferenceArray::get());
        jvm.method_area.add_native_method("java.util.concurrent.atomic.AtomicReferenceArray", AtomicReferenceArray::set());
    }
}
...
pub struct LinkedBlockingQueue;

impl LinkedBlockingQueue {
    pub fn init() -> Method {
        let native_impl: NativeImplementation = Arc::new(|frame, jvm| {
            let this_ref = frame.get_local(0)?;
            if let Value::ObjectRef(this_id) = this_ref {
        ...
        Method::new_native("java.util.concurrent.LinkedBlockingQueue".to_string(), "<init>".to_string(), "()V".to_string(), false, Some(native_impl))
    }
    ...
    pub fn put() -> Method {
        ...
        Method::new_native("java.util.concurrent.LinkedBlockingQueue".to_string(), "put".to_string(), "(Ljava/lang/Object;)V".to_string(), false, Some(native_impl))
    }
    ...
    pub fn take() -> Method {
        ...
        Method::new_native("java.util.concurrent.LinkedBlockingQueue".to_string(), "take".to_string(), "()Ljava/lang/Object;".to_string(), false, Some(native_impl))
    }
    ...
    pub fn size() -> Method {
        ...
        Method::new_native("java.util.concurrent.LinkedBlockingQueue".to_string(), "size".to_string(), "()I".to_string(), false, Some(native_impl))
    }

    pub fn register(jvm: &mut JVM) {
        jvm.method_area.add_native_method("java.util.concurrent.LinkedBlockingQueue", LinkedBlockingQueue::init());
        jvm.method_area.add_native_method("java.util.concurrent.LinkedBlockingQueue", LinkedBlockingQueue::put());
        jvm.method_area.add_native_method("java.util.concurrent.LinkedBlockingQueue", LinkedBlockingQueue::take());
        jvm.method_area.add_native_method("java.util.concurrent.LinkedBlockingQueue", LinkedBlockingQueue::size());
    }
}
...
pub struct ConcurrentSkipListMap;
...
impl ConcurrentSkipListMap {
    pub fn init() -> Method {
        ...
        Method::new_native("java.util.concurrent.ConcurrentSkipListMap".to_string(), "<init>".to_string(), "()V".to_string(), false, Some(native_impl))
    }
    ...
    pub fn put() -> Method {
        ...
        Method::new_native("java.util.concurrent.ConcurrentSkipListMap".to_string(), "put".to_string(), "(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;".to_string(), false, Some(native_impl))
    }
    ...
    pub fn get() -> Method {
        ...
        Method::new_native("java.util.concurrent.ConcurrentSkipListMap".to_string(), "get".to_string(), "(Ljava/lang/Object;)Ljava/lang/Object;".to_string(), false, Some(native_impl))
    }
    ...
    pub fn size() -> Method {
        ...
        Method::new_native("java.util.concurrent.ConcurrentSkipListMap".to_string(), "size".to_string(), "()I".to_string(), false, Some(native_impl))
    }

    pub fn register(jvm: &mut JVM) {
        jvm.method_area.add_native_method("java.util.concurrent.ConcurrentSkipListMap", ConcurrentSkipListMap::init());
        jvm.method_area.add_native_method("java.util.concurrent.ConcurrentSkipListMap", ConcurrentSkipListMap::put());
        jvm.method_area.add_native_method("java.util.concurrent.ConcurrentSkipListMap", ConcurrentSkipListMap::get());
        jvm.method_area.add_native_method("java.util.concurrent.ConcurrentSkipListMap", ConcurrentSkipListMap::size());
    }
}
...
pub struct PriorityBlockingQueue;

impl PriorityBlockingQueue {
    pub fn init() -> Method {
        let native_impl: NativeImplementation = Arc::new(|frame, jvm| {
            let this_ref = frame.get_local(0)?;
            if let Value::ObjectRef(this_id) = this_ref {
        ...
        Method::new_native("java.util.concurrent.PriorityBlockingQueue".to_string(), "<init>".to_string(), "()V".to_string(), false, Some(native_impl))
    }
    ...
    pub fn put() -> Method {
        ...
        Method::new_native("java.util.concurrent.PriorityBlockingQueue".to_string(), "put".to_string(), "(Ljava/lang/Object;)V".to_string(), false, Some(native_impl))
    }
    ...
    pub fn take() -> Method {
        ...
        Method::new_native("java.util.concurrent.PriorityBlockingQueue".to_string(), "take".to_string(), "()Ljava/lang/Object;".to_string(), false, Some(native_impl))
    }
    ...
    pub fn size() -> Method {
        ...
        Method::new_native("java.util.concurrent.PriorityBlockingQueue".to_string(), "size".to_string(), "()I".to_string(), false, Some(native_impl))
    }

    pub fn register(jvm: &mut JVM) {
        jvm.method_area.add_native_method("java.util.concurrent.PriorityBlockingQueue", PriorityBlockingQueue::init());
        jvm.method_area.add_native_method("java.util.concurrent.PriorityBlockingQueue", PriorityBlockingQueue::put());
        jvm.method_area.add_native_method("java.util.concurrent.PriorityBlockingQueue", PriorityBlockingQueue::take());
        jvm.method_area.add_native_method("java.util.concurrent.PriorityBlockingQueue", PriorityBlockingQueue::size());
    }
}
...
impl DelayQueue {
    pub fn init() -> Method {
        ...
        Method::new_native("java.util.concurrent.DelayQueue".to_string(), "<init>".to_string(), "()V".to_string(), false, Some(native_impl))
    }
    ...
    pub fn put() -> Method {
        ...
        Method::new_native("java.util.concurrent.DelayQueue".to_string(), "put".to_string(), "(Ljava/lang/Object;)V".to_string(), false, Some(native_impl))
    }
    ...
    pub fn take() -> Method {
        ...
        Method::new_native("java.util.concurrent.DelayQueue".to_string(), "take".to_string(), "()Ljava/lang/Object;".to_string(), false, Some(native_impl))
    }
    ...
    pub fn size() -> Method {
        ...
        Method::new_native("java.util.concurrent.DelayQueue".to_string(), "size".to_string(), "()I".to_string(), false, Some(native_impl))
    }

    pub fn register(jvm: &mut JVM) {
        jvm.method_area.add_native_method("java.util.concurrent.DelayQueue", DelayQueue::init());
        jvm.method_area.add_native_method("java.util.concurrent.DelayQueue", DelayQueue::put());
        jvm.method_area.add_native_method("java.util.concurrent.DelayQueue", DelayQueue::take());
        jvm.method_area.add_native_method("java.util.concurrent.DelayQueue", DelayQueue::size());
    }
}
...
pub struct CopyOnWriteArraySet;

impl CopyOnWriteArraySet {
    pub fn init() -> Method {
        let native_impl: NativeImplementation = Arc::new(|frame, jvm| {
            let this_ref = frame.get_local(0)?;
            if let Value::ObjectRef(this_id) = this_ref {
                ...
                let arr_ref = jvm.allocate(arr)?;
                if let Some(obj) = jvm.heap.get_mut(*this_id) {
                    obj.fields.insert("keys".to_string(), Value::ArrayRef(arr_ref));
                    obj.fields.insert("size".to_string(), Value::Int(0));
                }
            }
            Ok(())
        });
        Method::new_native("java.util.concurrent.CopyOnWriteArraySet".to_string(), "<init>".to_string(), "()V".to_string(), false, Some(native_impl))
    }
    ...
    pub fn add() -> Method {
        ...
        Method::new_native("java.util.concurrent.CopyOnWriteArraySet".to_string(), "add".to_string(), "(Ljava/lang/Object;)Z".to_string(), false, Some(native_impl))
    }
    ...
    pub fn contains() -> Method {
            ...
            if let Value::ObjectRef(this_id) = this_ref {
                if let Some(obj) = jvm.heap.get(*this_id) {
                    ...
                    if let Some(keys_arr) = jvm.heap.get(keys_ref) {
                        if let Some(keys) = &keys_arr.array_elements {
                            for i in 0..size {
                                if i < keys.len() && values_equal(&*jvm, &keys[i], &elem) { found = true; break; }
                            }
                        }
                    }
                }
        ...
        Method::new_native("java.util.concurrent.CopyOnWriteArraySet".to_string(), "contains".to_string(), "(Ljava/lang/Object;)Z".to_string(), false, Some(native_impl))
    }
    ...
    pub fn size() -> Method {
        ...
        Method::new_native("java.util.concurrent.CopyOnWriteArraySet".to_string(), "size".to_string(), "()I".to_string(), false, Some(native_impl))
    }

    pub fn register(jvm: &mut JVM) {
        jvm.method_area.add_native_method("java.util.concurrent.CopyOnWriteArraySet", CopyOnWriteArraySet::init());
        jvm.method_area.add_native_method("java.util.concurrent.CopyOnWriteArraySet", CopyOnWriteArraySet::add());
        jvm.method_area.add_native_method("java.util.concurrent.CopyOnWriteArraySet", CopyOnWriteArraySet::contains());
        jvm.method_area.add_native_method("java.util.concurrent.CopyOnWriteArraySet", CopyOnWriteArraySet::size());
    }
}

// ========== java.util.concurrent.ConcurrentLinkedDeque ==========

pub struct ConcurrentLinkedDeque;

impl ConcurrentLinkedDeque {
    pub fn init() -> Method {
        let native_impl: NativeImplementation = Arc::new(|frame, jvm| {
            let this_ref = frame.get_local(0)?;
            if let Value::ObjectRef(this_id) = this_ref {
        ...
        Method::new_native("java.util.concurrent.ConcurrentLinkedDeque".to_string(), "<init>".to_string(), "()V".to_string(), false, Some(native_impl))
    }
    ...
    pub fn addFirst() -> Method {
            ...
            if let Value::ObjectRef(this_id) = this_ref {
                ...
                if let Some(arr) = jvm.heap.get_mut(arr_ref) {
                    if let Some(elements) = &mut arr.array_elements {
                        ...
                        if current_size < elements.len() {
                            for i in (0..current_size).rev() { elements[i + 1] = elements[i].clone(); }
                            elements[0] = elem;
                        }
                    }
                }
        ...
        Method::new_native("java.util.concurrent.ConcurrentLinkedDeque".to_string(), "addFirst".to_string(), "(Ljava/lang/Object;)V".to_string(), false, Some(native_impl))
    }
    ...
    pub fn addLast() -> Method {
        ...
        Method::new_native("java.util.concurrent.ConcurrentLinkedDeque".to_string(), "addLast".to_string(), "(Ljava/lang/Object;)V".to_string(), false, Some(native_impl))
    }
    ...
    pub fn pollFirst() -> Method {
        ...
        Method::new_native("java.util.concurrent.ConcurrentLinkedDeque".to_string(), "pollFirst".to_string(), "()Ljava/lang/Object;".to_string(), false, Some(native_impl))
    }
    ...
    pub fn pollLast() -> Method {
        ...
        Method::new_native("java.util.concurrent.ConcurrentLinkedDeque".to_string(), "pollLast".to_string(), "()Ljava/lang/Object;".to_string(), false, Some(native_impl))
    }
    ...
    pub fn size() -> Method {
        ...
        Method::new_native("java.util.concurrent.ConcurrentLinkedDeque".to_string(), "size".to_string(), "()I".to_string(), false, Some(native_impl))
    }

    pub fn register(jvm: &mut JVM) {
        jvm.method_area.add_native_method("java.util.concurrent.ConcurrentLinkedDeque", ConcurrentLinkedDeque::init());
        jvm.method_area.add_native_method("java.util.concurrent.ConcurrentLinkedDeque", ConcurrentLinkedDeque::addFirst());
        jvm.method_area.add_native_method("java.util.concurrent.ConcurrentLinkedDeque", ConcurrentLinkedDeque::addLast());
        jvm.method_area.add_native_method("java.util.concurrent.ConcurrentLinkedDeque", ConcurrentLinkedDeque::pollFirst());
        jvm.method_area.add_native_method("java.util.concurrent.ConcurrentLinkedDeque", ConcurrentLinkedDeque::pollLast());
        jvm.method_area.add_native_method("java.util.concurrent.ConcurrentLinkedDeque", ConcurrentLinkedDeque::size());
    }
}

// ========== java.util.concurrent.LinkedTransferQueue ==========

pub struct LinkedTransferQueue;

impl LinkedTransferQueue {
    pub fn init() -> Method {
        let native_impl: NativeImplementation = Arc::new(|frame, jvm| {
            let this_ref = frame.get_local(0)?;
            if let Value::ObjectRef(this_id) = this_ref {
        ...
        Method::new_native("java.util.concurrent.LinkedTransferQueue".to_string(), "<init>".to_string(), "()V".to_string(), false, Some(native_impl))
    }
    ...
    pub fn transfer() -> Method {
        ...
        Method::new_native("java.util.concurrent.LinkedTransferQueue".to_string(), "transfer".to_string(), "(Ljava/lang/Object;)V".to_string(), false, Some(native_impl))
    }
    ...
    pub fn tryTransfer() -> Method {
        ...
        Method::new_native("java.util.concurrent.LinkedTransferQueue".to_string(), "tryTransfer".to_string(), "(Ljava/lang/Object;)Z".to_string(), false, Some(native_impl))
    }
    ...
    pub fn put() -> Method {
        ...
        Method::new_native("java.util.concurrent.LinkedTransferQueue".to_string(), "put".to_string(), "(Ljava/lang/Object;)V".to_string(), false, Some(native_impl))
    }
    ...
    pub fn take() -> Method {
        let native_impl: NativeImplementation = Arc::new(|frame, jvm| {
            ...
            if let Value::ObjectRef(this_id) = this_ref {
                ...
                if current_size > 0 {
                    let result = if let Some(queue) = jvm.heap.get(queue_ref) {
                        if let Some(elements) = &queue.array_elements { elements[0].clone() } else { Value::Null }
                    } else { Value::Null };
                    if let Some(queue) = jvm.heap.get_mut(queue_ref) {
                        if let Some(elements) = &mut queue.array_elements {
                            for i in 0..current_size - 1 { elements[i] = elements[i + 1].clone(); }
        ...
        Method::new_native("java.util.concurrent.LinkedTransferQueue".to_string(), "take".to_string(), "()Ljava/lang/Object;".to_string(), false, Some(native_impl))
    }
    ...
    pub fn size() -> Method {
        ...
        Method::new_native("java.util.concurrent.LinkedTransferQueue".to_string(), "size".to_string(), "()I".to_string(), false, Some(native_impl))
    }

    pub fn register(jvm: &mut JVM) {
        jvm.method_area.add_native_method("java.util.concurrent.LinkedTransferQueue", LinkedTransferQueue::init());
        jvm.method_area.add_native_method("java.util.concurrent.LinkedTransferQueue", LinkedTransferQueue::transfer());
        jvm.method_area.add_native_method("java.util.concurrent.LinkedTransferQueue", LinkedTransferQueue::tryTransfer());
        jvm.method_area.add_native_method("java.util.concurrent.LinkedTransferQueue", LinkedTransferQueue::put());
        jvm.method_area.add_native_method("java.util.concurrent.LinkedTransferQueue", LinkedTransferQueue::take());
        jvm.method_area.add_native_method("java.util.concurrent.LinkedTransferQueue", LinkedTransferQueue::size());
    }
}
...
pub struct LinkedBlockingDeque;

impl LinkedBlockingDeque {
    pub fn init() -> Method {
        let native_impl: NativeImplementation = Arc::new(|frame, jvm| {
            let this_ref = frame.get_local(0)?;
            if let Value::ObjectRef(this_id) = this_ref {
        ...
        Method::new_native("java.util.concurrent.LinkedBlockingDeque".to_string(), "<init>".to_string(), "()V".to_string(), false, Some(native_impl))
    }
    ...
    pub fn putFirst() -> Method {
        ...
        Method::new_native("java.util.concurrent.LinkedBlockingDeque".to_string(), "putFirst".to_string(), "(Ljava/lang/Object;)V".to_string(), false, Some(native_impl))
    }
    ...
    pub fn putLast() -> Method {
        ...
        Method::new_native("java.util.concurrent.LinkedBlockingDeque".to_string(), "putLast".to_string(), "(Ljava/lang/Object;)V".to_string(), false, Some(native_impl))
    }
    ...
    pub fn takeFirst() -> Method {
        let native_impl: NativeImplementation = Arc::new(|frame, jvm| {
            ...
            if let Value::ObjectRef(this_id) = this_ref {
                ...
                if current_size > 0 {
                    let result = if let Some(arr) = jvm.heap.get(arr_ref) {
                        if let Some(elements) = &arr.array_elements { elements[0].clone() } else { Value::Null }
                    } else { Value::Null };
                    if let Some(arr) = jvm.heap.get_mut(arr_ref) {
                        if let Some(elements) = &mut arr.array_elements {
                            for i in 0..current_size - 1 { elements[i] = elements[i + 1].clone(); }
        ...
        Method::new_native("java.util.concurrent.LinkedBlockingDeque".to_string(), "takeFirst".to_string(), "()Ljava/lang/Object;".to_string(), false, Some(native_impl))
    }
    ...
    pub fn takeLast() -> Method {
        ...
        Method::new_native("java.util.concurrent.LinkedBlockingDeque".to_string(), "takeLast".to_string(), "()Ljava/lang/Object;".to_string(), false, Some(native_impl))
    }
    ...
    pub fn size() -> Method {
        ...
        Method::new_native("java.util.concurrent.LinkedBlockingDeque".to_string(), "size".to_string(), "()I".to_string(), false, Some(native_impl))
    }

    pub fn register(jvm: &mut JVM) {
        jvm.method_area.add_native_method("java.util.concurrent.LinkedBlockingDeque", LinkedBlockingDeque::init());
        jvm.method_area.add_native_method("java.util.concurrent.LinkedBlockingDeque", LinkedBlockingDeque::putFirst());
        jvm.method_area.add_native_method("java.util.concurrent.LinkedBlockingDeque", LinkedBlockingDeque::putLast());
        jvm.method_area.add_native_method("java.util.concurrent.LinkedBlockingDeque", LinkedBlockingDeque::takeFirst());
        jvm.method_area.add_native_method("java.util.concurrent.LinkedBlockingDeque", LinkedBlockingDeque::takeLast());
        jvm.method_area.add_native_method("java.util.concurrent.LinkedBlockingDeque", LinkedBlockingDeque::size());
    }
}
...
impl EnumMap {
    pub fn init() -> Method {
        ...
        Method::new_native("java.util.EnumMap".to_string(), "<init>".to_string(), "()V".to_string(), false, Some(native_impl))
    }
    ...
    pub fn put() -> Method {
        ...
        Method::new_native("java.util.EnumMap".to_string(), "put".to_string(), "(Ljava/lang/Enum;Ljava/lang/Object;)Ljava/lang/Object;".to_string(), false, Some(native_impl))
    }
    ...
    pub fn get() -> Method {
        ...
        Method::new_native("java.util.EnumMap".to_string(), "get".to_string(), "(Ljava/lang/Object;)Ljava/lang/Object;".to_string(), false, Some(native_impl))
    }
    ...
    pub fn size() -> Method {
        ...
        Method::new_native("java.util.EnumMap".to_string(), "size".to_string(), "()I".to_string(), false, Some(native_impl))
    }

    pub fn register(jvm: &mut JVM) {
        jvm.method_area.add_native_method("java.util.EnumMap", EnumMap::init());
        jvm.method_area.add_native_method("java.util.EnumMap", EnumMap::put());
        jvm.method_area.add_native_method("java.util.EnumMap", EnumMap::get());
        jvm.method_area.add_native_method("java.util.EnumMap", EnumMap::size());
    }
}
...
impl ReflectMember {
    pub fn getName() -> Method {
        ...
        Method::new_native("java.lang.reflect.Member".to_string(), "getName".to_string(), "()Ljava/lang/String;".to_string(), false, Some(native_impl))
    }

    pub fn getModifiers() -> Method {
        let native_impl: NativeImplementation = Arc::new(|frame, jvm| {
            let this_ref = frame.get_local(0)?;
            let mods = if let Value::ObjectRef(this_id) = this_ref {
                if let Some(obj) = jvm.heap.get(*this_id) {
                    obj.fields.get("modifiers")
                        .and_then(|v| if let Value::Int(m) = v { Some(*m) } else { None })
                        .unwrap_or(0)
                } else { 0 }
            } else { 0 };
            frame.push(Value::Int(mods))?;
            Ok(())
        });
        Method::new_native("java.lang.reflect.Member".to_string(), "getModifiers".to_string(), "()I".to_string(), false, Some(native_impl))
    }

    pub fn register(jvm: &mut JVM) {
        jvm.method_area.add_native_method("java.lang.reflect.Member", ReflectMember::getName());
        jvm.method_area.add_native_method("java.lang.reflect.Member", ReflectMember::getModifiers());
    }
}
